...
public class TestWorldEntryDeclarationBuilder<T> {
	...
	public TestWorldEntryDeclarationBuilder(
			TestWorldDirectoryDeclarationBuilder parent, String name,
			Class<T> clazz) {
		this.parent = parent;
		this.name = name;
		this.clazz = clazz;
	...
	public TestWorldEntryDeclarationBuilder<T> serializer(
			BiConsumer<OutputStream, T> serializer) {
		this.serializer = serializer;
		return this;
	}

	public TestWorldEntryDeclarationBuilder<T> deserializer(
			Function<InputStream, T> deserializer) {
		this.deserializer = deserializer;
		return this;
	}

	public TestWorldEntryDeclarationBuilder<T> extractor(
			Function<World, T> extractor) {
		this.extractor = extractor;
		return this;
	}

	public TestWorldEntryDeclarationBuilder<T> equalityChecker(
	...
	TestWorldEntryDeclaration<T> constructThis() {
		...
		return new TestWorldEntryDeclaration<T>(name, clazz, serializer,
				deserializer, extractor, equalityChecker, skipEqualityCheck);
	}
	...
	public <E> TestWorldEntryDeclarationBuilder<E> entry(String name,
			Class<E> clazz) {
