...
public class DefaultBiomes_v7 {

	private static Map<String, MinetestBiome[]> biomeLists = null;

	
	public static MinetestBiome[] getDefaultBiomeSet() {		
		Map.Entry<String, MinetestBiome[]> firstEntry = getCommonBiomeSets().entrySet().iterator().next();
	 ...
	 */
	public static Map<String, MinetestBiome[]> getCommonBiomeSets() {
		if (biomeLists == null) {
			...
			biomeLists.put(
				...
				setIndexes(
					new MinetestBiome[] {
						// Main biomes
						new MinetestBiome("Glacier 1",               BiomeColor.from(220, 220, 230), (short)  -6, Short.MAX_VALUE, -11,  20), 
						new MinetestBiome("Glacier 2",               BiomeColor.from(220, 220, 230), (short)   1, Short.MAX_VALUE, -19,  40), 
						new MinetestBiome("Glacier 3",               BiomeColor.from(220, 220, 230), (short)   1, Short.MAX_VALUE, -27,  80), 
						new MinetestBiome("Taiga",                   BiomeColor.from(220, 220, 230), (short)   4, Short.MAX_VALUE,  11,  67), 
						new MinetestBiome("Tundra",                  BiomeColor.from(220, 220, 230), (short)   3, Short.MAX_VALUE,   4,  32), 
						new MinetestBiome("Coniferous forest",       BiomeColor.from(220, 220, 230), (short)   5, Short.MAX_VALUE,  22,  71), 
						...
						new MinetestBiome("Cold desert",             BiomeColor.from(220, 220, 230), (short)   3, Short.MAX_VALUE,  32,  -3), 
						...
						new MinetestBiome("Stone grasslands",        BiomeColor.from(220, 220, 230), (short)   4, Short.MAX_VALUE,  29,  22), 
						...
						new MinetestBiome("Deciduous forest",        BiomeColor.from(220, 220, 230), (short)   5, Short.MAX_VALUE,  45,  65), 
						new MinetestBiome("Bushes",                  BiomeColor.from(220, 220, 230), (short)   7, Short.MAX_VALUE,  43,  30), 
						new MinetestBiome("Scrub",                   BiomeColor.from(220, 220, 230), (short)   8, Short.MAX_VALUE,  57,  25), 
						new MinetestBiome("Hot pine forest",         BiomeColor.from(220, 220, 230), (short)   6, Short.MAX_VALUE,  65,  35), 
						new MinetestBiome("Desert",                  BiomeColor.from(220, 220, 230), (short)   7, Short.MAX_VALUE,  89,   9), 
						new MinetestBiome("Sandstone grasslands",    BiomeColor.from(220, 220, 230), (short)   3, Short.MAX_VALUE,  55,  15), 
						new MinetestBiome("Savanna",                 BiomeColor.from(220, 220, 230), (short)   6, Short.MAX_VALUE,  80,  24), 
						...
						new MinetestBiome("Rainforest",              BiomeColor.from(220, 220, 230), (short)   1, Short.MAX_VALUE,  89,  76), 
						new MinetestBiome("Sandstone desert",        BiomeColor.from(220, 220, 230), (short)   6, Short.MAX_VALUE,  60,   0), 
						...
						new MinetestBiome("Sand dunes",              BiomeColor.from(220, 220, 230), (short)  -5,       (short) 5,  21,  61), 
						new MinetestBiome("Mangrove",                BiomeColor.from(220, 220, 230), (short)  -4,       (short) 0,  96, 106), 
						...
						new MinetestBiome("Tundra dunes",            BiomeColor.from(220, 220, 230), (short)  -5,       (short) 2,   5,  21), 
						...
						// Sea biomes                                                                                             
						new MinetestBiome("Pack ice",                BiomeColor.from(220, 220, 230), (short)-112,       (short)-6, -24,  41), 
						new MinetestBiome("Cold sea",                BiomeColor.from(220, 220, 230), (short)-112,       (short)-6,  20,  47), 
						new MinetestBiome("Tempered sea",            BiomeColor.from(220, 220, 230), (short)-112,       (short)-6,  41,  48), 
						new MinetestBiome("Warm sea",                BiomeColor.from(220, 220, 230), (short)-112,       (short)-6,  89,  51) 
