 ...
 */
@ThreadSafe
public class StrongholdProducer_AlogorithmUpdated extends
		StrongholdProducer_AlogorithmUpdateAttempt1 {
	public StrongholdProducer_AlogorithmUpdated(long seed,
