...
public class Biome {
	...
	public static final Biome ocean                = new Biome("Ocean",                       0, BiomeColor.from(0, 0, 112),      BiomeType.typeC);
	public static final Biome plains               = new Biome("Plains",                      1, BiomeColor.from(141, 179, 96),   BiomeType.typeA);
	public static final Biome desert               = new Biome("Desert",                      2, BiomeColor.from(250, 148, 24),   BiomeType.typeE);
	public static final Biome extremeHills         = new Biome("Extreme Hills",               3, BiomeColor.from(96, 96, 96),     BiomeType.typeI);
	public static final Biome forest               = new Biome("Forest",                      4, BiomeColor.from(5, 102, 33),     BiomeType.typeA);
	public static final Biome taiga                = new Biome("Taiga",                       5, BiomeColor.from(11, 102, 89),    BiomeType.typeF);
	public static final Biome swampland            = new Biome("Swampland",                   6, BiomeColor.from(7, 249, 178),    BiomeType.typeM);
	public static final Biome river                = new Biome("River",                       7, BiomeColor.from(0, 0, 255),      BiomeType.typeB);
	public static final Biome hell                 = new Biome("Hell",                        8, BiomeColor.from(255, 0, 0),      BiomeType.typeA);
	public static final Biome sky                  = new Biome("Sky",                         9, BiomeColor.from(128, 128, 255),  BiomeType.typeA);
	public static final Biome frozenOcean          = new Biome("Frozen Ocean",               10, BiomeColor.from(144, 144, 160),  BiomeType.typeC);
	public static final Biome frozenRiver          = new Biome("Frozen River",               11, BiomeColor.from(160, 160, 255),  BiomeType.typeB);
	public static final Biome icePlains            = new Biome("Ice Plains",                 12, BiomeColor.from(255, 255, 255),  BiomeType.typeE);
	public static final Biome iceMountains         = new Biome("Ice Mountains",              13, BiomeColor.from(160, 160, 160),  BiomeType.typeG);
	public static final Biome mushroomIsland       = new Biome("Mushroom Island",            14, BiomeColor.from(255, 0, 255),    BiomeType.typeL);
	public static final Biome mushroomIslandShore  = new Biome("Mushroom Island Shore",      15, BiomeColor.from(160, 0, 255),    BiomeType.typeJ);
	public static final Biome beach                = new Biome("Beach",                      16, BiomeColor.from(250, 222, 85),   BiomeType.typeJ);
	public static final Biome desertHills          = new Biome("Desert Hills",               17, BiomeColor.from(210, 95, 18),    BiomeType.typeG);
	public static final Biome forestHills          = new Biome("Forest Hills",               18, BiomeColor.from(34, 85, 28),     BiomeType.typeG);
	public static final Biome taigaHills           = new Biome("Taiga Hills",                19, BiomeColor.from(22, 57, 51),     BiomeType.typeG);
	public static final Biome extremeHillsEdge     = new Biome("Extreme Hills Edge",         20, BiomeColor.from(114, 120, 154),  BiomeType.typeI.getExtreme());
	public static final Biome jungle               = new Biome("Jungle",                     21, BiomeColor.from(83, 123, 9),     BiomeType.typeA);
	public static final Biome jungleHills          = new Biome("Jungle Hills",               22, BiomeColor.from(44, 66, 5),      BiomeType.typeG);
	public static final Biome jungleEdge           = new Biome("Jungle Edge",                23, BiomeColor.from(98, 139, 23),    BiomeType.typeA);
	public static final Biome deepOcean            = new Biome("Deep Ocean",                 24, BiomeColor.from(0, 0, 48),       BiomeType.typeD);
	public static final Biome stoneBeach           = new Biome("Stone Beach",                25, BiomeColor.from(162, 162, 132),  BiomeType.typeK);
	public static final Biome coldBeach            = new Biome("Cold Beach",                 26, BiomeColor.from(250, 240, 192),  BiomeType.typeJ);
	public static final Biome birchForest          = new Biome("Birch Forest",               27, BiomeColor.from(48, 116, 68),    BiomeType.typeA);
	public static final Biome birchForestHills     = new Biome("Birch Forest Hills",         28, BiomeColor.from(31, 95, 50),     BiomeType.typeG);
	public static final Biome roofedForest         = new Biome("Roofed Forest",              29, BiomeColor.from(64, 81, 26),     BiomeType.typeA);
	public static final Biome coldTaiga            = new Biome("Cold Taiga",                 30, BiomeColor.from(49, 85, 74),     BiomeType.typeF);
	public static final Biome coldTaigaHills       = new Biome("Cold Taiga Hills",           31, BiomeColor.from(36, 63, 54),     BiomeType.typeG);
	public static final Biome megaTaiga            = new Biome("Mega Taiga",                 32, BiomeColor.from(89, 102, 81),    BiomeType.typeF);
	public static final Biome megaTaigaHills       = new Biome("Mega Taiga Hills",           33, BiomeColor.from(69, 79, 62),     BiomeType.typeG);
	public static final Biome extremeHillsPlus     = new Biome("Extreme Hills+",             34, BiomeColor.from(80, 112, 80),    BiomeType.typeI);
	public static final Biome savanna              = new Biome("Savanna",                    35, BiomeColor.from(189, 178, 95),   BiomeType.typeE);
	public static final Biome savannaPlateau       = new Biome("Savanna Plateau",            36, BiomeColor.from(167, 157, 100),  BiomeType.typeH);
	public static final Biome mesa                 = new Biome("Mesa",                       37, BiomeColor.from(217, 69, 21),    BiomeType.typeA);
	public static final Biome mesaPlateauF         = new Biome("Mesa Plateau F",             38, BiomeColor.from(176, 151, 101),  BiomeType.typeH);
	public static final Biome mesaPlateau          = new Biome("Mesa Plateau",               39, BiomeColor.from(202, 140, 101),  BiomeType.typeH);
