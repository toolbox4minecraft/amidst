...
public class AmidstMenuBuilder {
	...
	private JMenuItem create_Layers() {
		...
		result.add(createJCheckBoxItem("Mineshaft Icons",          "mineshaft.png",       KeyEvent.VK_9, settings.showMineshafts.getButtonModel()));
		result.add(createJCheckBoxItem("Spawn Location Icon",      "spawn.png",           KeyEvent.VK_0, settings.showSpawn.getButtonModel()));
		// @formatter:on
		return result;
	}
