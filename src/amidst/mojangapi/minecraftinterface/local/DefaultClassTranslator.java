	...
	private ClassTranslator createClassTranslator() {
		return ClassTranslator
			.builder()
				...
				.thenDeclare(SymbolicNames.CLASS_INT_CACHE)
//					.method("getIntCache",                                  "a").real("int").end()
					.method(SymbolicNames.METHOD_INT_CACHE_RESET_INT_CACHE, "a").end()
...
//					.field("types",                                     "a")
					.field(SymbolicNames.FIELD_WORLD_TYPE_DEFAULT,      "b")
					.field(SymbolicNames.FIELD_WORLD_TYPE_FLAT,         "c")
					.field(SymbolicNames.FIELD_WORLD_TYPE_LARGE_BIOMES, "d")
					.field(SymbolicNames.FIELD_WORLD_TYPE_AMPLIFIED,    "e")
					.field(SymbolicNames.FIELD_WORLD_TYPE_CUSTOMIZED,   "f")
//					.field("default_1_1",                               "g")
			.next()
				.ifDetect()
					.longs(1000L, 2001L, 2000L)
				.thenDeclare(SymbolicNames.CLASS_GEN_LAYER)
					...
					.method(        SymbolicNames.METHOD_GEN_LAYER_GET_INTS,                          "a").real("int") .real("int")          .real("int")   .real("int").end()
			.next()
				.ifDetect()
				...
				.thenDeclareOptional(SymbolicNames.CLASS_BLOCK_INIT)
					.method(SymbolicNames.METHOD_BLOCK_INIT_INITIALIZE, "c").end()
			.construct();
	}
	// @formatter:on
