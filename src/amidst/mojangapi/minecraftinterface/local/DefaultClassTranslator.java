...
//					.field("default_1_1",       "g")
			.next()
				...
				.thenDeclare("GenLayer")
					...
					.optionalMethod("initializeAllBiomeGenerators1", "a").real("long").end()
					.optionalMethod("initializeAllBiomeGenerators2", "a").real("long").symbolic("WorldType").end()
					.optionalMethod("initializeAllBiomeGenerators3", "a").real("long").symbolic("WorldType").real("String").end()
