...
public class Biome {
	...
	public static final Biome ocean                = new Biome("Ocean",                  0, Util.makeColor(0, 0, 112));
	public static final Biome plains               = new Biome("Plains",                 1, Util.makeColor(141, 179, 96));
	public static final Biome desert               = new Biome("Desert",                 2, Util.makeColor(250, 148, 24));
	public static final Biome extremeHills         = new Biome("Extreme Hills",          3, Util.makeColor(96, 96, 96));
	public static final Biome forest               = new Biome("Forest",                 4, Util.makeColor(5, 102, 33));
	public static final Biome taiga                = new Biome("Taiga",                  5, Util.makeColor(11, 102, 89));
	public static final Biome swampland            = new Biome("Swampland",              6, Util.makeColor(7, 249, 178));
	public static final Biome river                = new Biome("River",                  7, Util.makeColor(0, 0, 255));
	public static final Biome hell                 = new Biome("Hell",                   8, Util.makeColor(255, 0, 0));
	public static final Biome sky                  = new Biome("Sky",                    9, Util.makeColor(128, 128, 255));
	public static final Biome frozenOcean          = new Biome("Frozen Ocean",          10, Util.makeColor(144, 144, 160));
	public static final Biome frozenRiver          = new Biome("Frozen River",          11, Util.makeColor(160, 160, 255));
	public static final Biome icePlains            = new Biome("Ice Plains",            12, Util.makeColor(255, 255, 255));
	public static final Biome iceMountains         = new Biome("Ice Mountains",         13, Util.makeColor(160, 160, 160));
	public static final Biome mushroomIsland       = new Biome("Mushroom Island",       14, Util.makeColor(255, 0, 255));
	public static final Biome mushroomIslandShore  = new Biome("Mushroom Island Shore", 15, Util.makeColor(160, 0, 255));
	public static final Biome beach                = new Biome("Beach",                 16, Util.makeColor(250, 222, 85));
	public static final Biome desertHills          = new Biome("Desert Hills",          17, Util.makeColor(210, 95, 18));
	public static final Biome forestHills          = new Biome("Forest Hills",          18, Util.makeColor(34, 85, 28));
	public static final Biome taigaHills           = new Biome("Taiga Hills",           19, Util.makeColor(22, 57, 51));
	public static final Biome extremeHillsEdge     = new Biome("Extreme Hills Edge",    20, Util.makeColor(114, 120, 154));
	public static final Biome jungle               = new Biome("Jungle",                21, Util.makeColor(83, 123, 9));
	public static final Biome jungleHills          = new Biome("Jungle Hills",          22, Util.makeColor(44, 66, 5));
	public static final Biome jungleEdge           = new Biome("Jungle Edge",           23, Util.makeColor(98, 139, 23));
	public static final Biome deepOcean            = new Biome("Deep Ocean",            24, Util.makeColor(0, 0, 48));
	public static final Biome stoneBeach           = new Biome("Stone Beach",           25, Util.makeColor(162, 162, 132));
	public static final Biome coldBeach            = new Biome("Cold Beach",            26, Util.makeColor(250, 240, 192));
	public static final Biome birchForest          = new Biome("Birch Forest",          27, Util.makeColor(48, 116, 68));
	public static final Biome birchForestHills     = new Biome("Birch Forest Hills",    28, Util.makeColor(31, 95, 50));
	public static final Biome roofedForest         = new Biome("Roofed Forest",         29, Util.makeColor(64, 81, 26));
	public static final Biome coldTaiga            = new Biome("Cold Taiga",            30, Util.makeColor(49, 85, 74));
	public static final Biome coldTaigaHills       = new Biome("Cold Taiga Hills",      31, Util.makeColor(36, 63, 54));
	public static final Biome megaTaiga            = new Biome("Mega Taiga",            32, Util.makeColor(89, 102, 81));
	public static final Biome megaTaigaHills       = new Biome("Mega Taiga Hills",      33, Util.makeColor(69, 79, 62));
	public static final Biome extremeHillsPlus     = new Biome("Extreme Hills+",        34, Util.makeColor(80, 112, 80));
	public static final Biome savanna              = new Biome("Savanna",               35, Util.makeColor(189, 178, 95));
	public static final Biome savannaPlateau       = new Biome("Savanna Plateau",       36, Util.makeColor(167, 157, 100));
	public static final Biome mesa                 = new Biome("Mesa",                  37, Util.makeColor(217, 69, 21));
	public static final Biome mesaPlateauF         = new Biome("Mesa Plateau F",        38, Util.makeColor(176, 151, 101));
	public static final Biome mesaPlateau          = new Biome("Mesa Plateau",          39, Util.makeColor(202, 140, 101));
