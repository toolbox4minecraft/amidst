...
public interface IMinecraftInterface {
	 ...
	 * 
	 *            When useQuarterResolutionMap is true, the x, y, width, and
	 *            height paramaters must all correspond to a quarter of the
	 *            Minecraft block coordinates/sizes you wish to obtain the biome
	 *            data for.
	 * 
