...
public class MinecraftProperty {
	...
	public MinecraftProperty(MinecraftClass minecraftClass,
			String minecraftPropertyName, String bytePropertyName) {
	...
	public String toString() {
		return "[Method " + name + " (" + internalName + ") of class "
	...
	private Object getValue(Object obj) {
		try {
			...
			e.printStackTrace();
			Log.crash(e, "Error [IllegalArgumentException] loading property ("
					+ toString() + ")");
		} catch (IllegalAccessException e) {
			e.printStackTrace();
			Log.crash(e, "Error [IllegalAccessException] loading property ("
					+ toString() + ")");
		}
		return null;
	}
