			...
			return ClassTranslator
				.builder()
					...
					.declare("IntCache")
						...
						.property("intCacheSize", 		"a")
						.property("freeSmallArrays", 	"b")
						.property("inUseSmallArrays", 	"c")
						.property("freeLargeArrays", 	"d")
						.property("inUseLargeArrays", 	"e")
				.next()
					.detect()
						.strings("default_1_1")
					.declare("WorldType")
						...
						.property("default", 		"b")
						.property("flat", 			"c")
						.property("largeBiomes", 	"d")
						.property("amplified", 		"e")
						.property("customized", 	"f")
						.property("default_1_1", 	"g")
				.next()
					.detect()
