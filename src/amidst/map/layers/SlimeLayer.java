	...
	public void drawToCache(Fragment fragment) {
		...
		for (int y = 0; y < size; y++) {
			for (int x = 0; x < size; x++) {
				...
				random.setSeed(Options.instance.seed + xPosition * xPosition
						* 0x4c1906 + xPosition * 0x5ac0db + yPosition
						* yPosition * 0x4307a7L + yPosition * 0x5f24f
						^ 0x3ad8025f);

				dataCache[y * size + x] = (random.nextInt(10) == 0) ? 0xA0FF00FF
						: 0x00000000;
			}
		}
